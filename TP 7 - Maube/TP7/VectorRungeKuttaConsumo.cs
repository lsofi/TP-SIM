...
namespace TP7
{
    class VectorRungeKuttaConsumo
    {
        ...
        public VectorRungeKuttaConsumo(double t, double x, double h)
        {
            this.t = t;
            this.x = x;
            this.h = h;
        ...
        public VectorRungeKuttaConsumo(double x, double h)
        {
            this.t = 0;
            this.x = x;
            this.h = h;
        ...
        public VectorRungeKuttaConsumo siguiente()
        {
            double incX = (h / 6) * (k1 + 2 * k2 + 2 * k3 + k4);
            VectorRungeKuttaConsumo res = new VectorRungeKuttaConsumo(t + h, x + incX, h);
            res.calcularValores();
            return res;
        }
